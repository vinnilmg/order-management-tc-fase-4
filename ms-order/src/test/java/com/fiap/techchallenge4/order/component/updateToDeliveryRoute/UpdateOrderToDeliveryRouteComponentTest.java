package com.fiap.techchallenge4.order.component.updateToDeliveryRoute;
...
@ContextConfiguration(classes = {
        UpdateOrderToDeliveryRouteConfiguration.class,
        OrderController.class,
        UpdateOrderShippingInfoUseCaseImpl.class,
...
class UpdateOrderToDeliveryRouteComponentTest extends AbstractJUnit4SpringContextTests {
    private static final String ENDPOINT = "/api/orders/{id}/shipping";
    ...
    @Test
    void shouldUpdateOrderToDeliveryRoute() throws Exception {
        final var id = ORDER_ID;

        when(orderRepository.findById(id))
                .thenReturn(Optional.of(OrderEntityFixture.AGUARDANDO_ENVIO()));
        ...
        verify(orderRepository).updateStatus(eq(id), anyString());
    }

    @Test
    void shouldNotUpdateOrderToDeliveryRoute() throws Exception {
        final var id = ORDER_ID;
